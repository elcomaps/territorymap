...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <h4 class="title d-block d-md-flex align-items-end">
                    ...
                    <div class="ml-auto mt-2 mt-md-0">
                        <div class="dropdown mega-dropdown approved-users-filter">
                            <button class="btn btn-custom no-background checkbox-action" type="button" info="pending">
                                Unapprove
                            </button>
                            <button class="btn btn-custom no-background checkbox-action" type="button" info="delete">
                                Delete
                            </button>
                            <select class="custom-select font-16 auto-width page-rowcount" id="approved-users-rowcount" title="Rows on page">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive approved-users">
                        ...
                        <p class="approved-users-nomessage">There is no approved user available at the moment.</p>
                    </div>
                </div>
            </div>
            <div style="display: none;" id="usertable-dropbox">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" action="unapprove-user" href="#"><i class="mr-2"
                                data-feather="edit"></i>Unapprove</a>
            ...
            <script src="./assets/user-approved.js"></script>
<?php
