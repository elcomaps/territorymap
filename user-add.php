...
?>
        ...
        <div class="page-wrapper">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group pr-2">
                                                        ...
                                                        <input class="form-control" type="text" id="newuser-firstname" 
                                                            placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mt-3 mt-md-0">
                                                    <div class="form-group pl-1">
                                                        ...
                                                        <input class="form-control" type="text" id="newuser-lastname" 
                                                            placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row mt-3">
                                                <div class="col-md-6">
                                                    <div class="form-group pr-1">
                                                        ...
                                                        <input class="form-control" type="text" id="newuser-username" 
                                                            placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mt-3 mt-md-0">
                                                    <div class="form-group pl-1">
                                                        ...
                                                        <input class="form-control" type="text" id="newuser-email" 
                                                            placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row mt-3">
                                                <div class="col-md-6">
                                                    <div class="form-group pr-1">
                                                        ...
                                                        <input class="form-control" type="text" id="newuser-password" 
                                                            placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group pr-1">
                                                        ...
                                                        <input class="form-control" type="text" id="newuser-confirmpassword" 
                                                            placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row mt-3">
                                                <div class="col-md-6">
                                                    <div class="form-group pr-1">
                                                        ...
                                                        <select class="form-control" id="newuser-userrole">
                                            ...
                                            <div class="form-row mt-3">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <button type="button" class="btn btn-primary" id="newsuer-register-btn">Create</button>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <script src="./assets/user-add.js"></script>
<?php
