...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <h4 class="title d-block d-md-flex align-items-end">
                    ...
                    <div class="ml-auto mt-2 mt-md-0">
                        <div class="dropdown mega-dropdown deleted-users-filter">
                            ...
                            <button class="btn btn-custom no-background checkbox-action" type="button" info="remove">
                                Delete
                            </button>
                            <select class="custom-select font-16 auto-width page-rowcount" id="deleted-users-rowcount" title="Rows on page">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive deleted-users">
                        ...
                        <p class="deleted-users-nomessage">There is no deleted user available at the moment.</p>
                    </div>
                </div>
            </div>
            <div style="display: none;" id="usertable-dropbox">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" action="remove-user" href="#"><i class="mr-2"
                                data-feather="delete"></i>Delete Permanently</a>
                    </div>
                </div>
            </div>
            ...
            <script src="./assets/user-deleted.js"></script>
<?php
